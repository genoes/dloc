...
### Steps
1. Open Terminal, run ```git clone https://github.com/genoes/idep-dloc-metadata-mapping.git```, and change your current working directory to the "idep" folder. You may delete the "meap" folder from your working directory.
